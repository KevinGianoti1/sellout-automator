...
names = ['Agnes', 'Camila', 'Fernanda', 'Ana Paula', 'Wellington', 'Bruno', 'Vinicius', 'Derec', 'Matheus']
usernames = ['agnes', 'camila', 'fernanda', 'ana', 'wellington', 'bruno', 'vinicius', 'derec', 'matheus']
...
credentials = {
    "usernames": {
        username: {"name": name, "password": hashed}
